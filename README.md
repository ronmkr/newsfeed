...
|                                1. INGESTION SERVICE                                   |
|  [RSS Feeds] ----+                                                                    |
|  [Sitemaps]  ----+---> [Ingestion Coordinator] ---> [Deduplicator] ---> [Extractor]   |
|  [Spiders]   ----+                                                                    |
+--------------------------+-------------------------------------------+----------------+
                           |
                           v
...
|                                                                                       |
|   [[ Scout Node ]]  ----->  {{ Summarizer Node }}  ----->  {{ Auditor Node }}         |
|   (FastEmbed Grouping)      (Gemini 1.5 Flash)             (Gemini 1.5 Pro)           |
|          ^                                                        |                   |
|          |                        [[ Editor Node ]] <-------------+                   |
|          +----------------------- (Blindspot Detection)                               |
+--------------------------+-------------------------------------------+----------------+
...
|   [( SQLite DB )] <----- [ Repository Layer ] -----> [ Markdown Report Generator ]     |
+---------------------------------------------------------------------------------------+
```
